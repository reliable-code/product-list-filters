export const SELECTORS = {
    ...
    PRICE_CONTAINER: '.goods-card__price',
    PRODUCT_CARD_NAME: '.favorites-card__brand-wrap',
    WALLET_PRICE: '.wallet-price',
    PRICE: '.goods-card__price-now',
    OUT_OF_STOCK_LABEL: '.goods-card__out-stock',
    SIMILAR_BUTTON: '.goods-card__similar',
};
