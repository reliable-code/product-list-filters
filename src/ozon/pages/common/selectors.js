export const SELECTORS = {
    ...
    PRODUCT_CARDS: '.widget-search-result-container .tile-root, #contentScrollPaginator .tile-root',
    ...
    PRODUCT_CARDS_WRAP: '#contentScrollPaginator [data-widget="tileGridDesktop"]',
};
